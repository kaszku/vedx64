...
static bool lift_exec_switch(Lifted& l, const DecodedInstr& di, uint8_t sz, bool rex_w, bool has_66, size_t n, uint64_t address) {
    ...
    if (m == Mnemonic::ADDPS || m == Mnemonic::ADDPD || m == Mnemonic::ADDSS || m == Mnemonic::ADDSD ||
        ...
        Opcode opc = (m == Mnemonic::SUBPS || m == Mnemonic::SUBPD || m == Mnemonic::SUBSS || m == Mnemonic::SUBSD)
            ? Opcode::SUB : Opcode::ADD;
        uint8_t vsz = (m == Mnemonic::ADDSS || m == Mnemonic::SUBSS) ? 4 :
                       (m == Mnemonic::ADDSD || m == Mnemonic::SUBSD) ? 8 : 16;
        if (mod_ == 3) {
    ...
    if (m == Mnemonic::MULPS || m == Mnemonic::MULPD || m == Mnemonic::MULSS || m == Mnemonic::MULSD ||
        m == Mnemonic::DIVPS || m == Mnemonic::DIVPD || m == Mnemonic::DIVSS || m == Mnemonic::DIVSD) {
        Opcode opc = (m == Mnemonic::DIVPS || m == Mnemonic::DIVPD || m == Mnemonic::DIVSS || m == Mnemonic::DIVSD)
            ? Opcode::DIV : Opcode::MUL;
        uint8_t vsz = (m == Mnemonic::MULSS || m == Mnemonic::DIVSS) ? 4 :
                       (m == Mnemonic::MULSD || m == Mnemonic::DIVSD) ? 8 : 16;
        if (mod_ == 3) {
            VarNode dst = VarNode::xmm(((di.modrm >> 3) & 7) | ((di.rex & 0x04) ? 8 : 0), vsz);
            VarNode src = VarNode::xmm((di.modrm & 7) | ((di.rex & 0x01) ? 8 : 0), vsz);
            l.ops.push_back(make_op3(opc, dst, dst, src));
    ...
    if (m == Mnemonic::SQRTPS || m == Mnemonic::SQRTPD || m == Mnemonic::SQRTSS || m == Mnemonic::SQRTSD ||
        m == Mnemonic::RCPPS || m == Mnemonic::RCPSS || m == Mnemonic::RSQRTPS || m == Mnemonic::RSQRTSS) {
        uint8_t vsz = (m == Mnemonic::SQRTSS || m == Mnemonic::RCPSS || m == Mnemonic::RSQRTSS) ? 4 :
                       (m == Mnemonic::SQRTSD) ? 8 : 16;
        if (mod_ == 3) {
            VarNode dst = VarNode::xmm(((di.modrm >> 3) & 7) | ((di.rex & 0x04) ? 8 : 0), vsz);
            VarNode src = VarNode::xmm((di.modrm & 7) | ((di.rex & 0x01) ? 8 : 0), vsz);
            l.ops.push_back(make_op2(Opcode::COPY, dst, src));
    ...
    if (m == Mnemonic::MAXPS || m == Mnemonic::MAXPD || m == Mnemonic::MAXSS || m == Mnemonic::MAXSD ||
        m == Mnemonic::MINPS || m == Mnemonic::MINPD || m == Mnemonic::MINSS || m == Mnemonic::MINSD) {
        uint8_t vsz = (m == Mnemonic::MAXSS || m == Mnemonic::MINSS) ? 4 :
                       (m == Mnemonic::MAXSD || m == Mnemonic::MINSD) ? 8 : 16;
        if (mod_ == 3) {
            VarNode dst = VarNode::xmm(((di.modrm >> 3) & 7) | ((di.rex & 0x04) ? 8 : 0), vsz);
            VarNode src = VarNode::xmm((di.modrm & 7) | ((di.rex & 0x01) ? 8 : 0), vsz);
            l.ops.push_back(make_op3(Opcode::SUB, dst, dst, src)); // approximate: compare via sub
        } else {
            VarNode ea = compute_ea(l, di);
            VarNode dst = VarNode::xmm(((di.modrm >> 3) & 7) | ((di.rex & 0x04) ? 8 : 0), vsz);
            VarNode tmp = VarNode::temp(20, vsz);
    ...
    if (m == Mnemonic::ANDPS || m == Mnemonic::ANDPD || m == Mnemonic::ORPS || m == Mnemonic::ORPD ||
        m == Mnemonic::XORPS || m == Mnemonic::XORPD || m == Mnemonic::ANDNPS || m == Mnemonic::ANDNPD) {
        Opcode opc;
        bool is_andn = (m == Mnemonic::ANDNPS || m == Mnemonic::ANDNPD);
        if (m == Mnemonic::ANDPS || m == Mnemonic::ANDPD || is_andn) opc = Opcode::AND;
        else if (m == Mnemonic::ORPS || m == Mnemonic::ORPD) opc = Opcode::OR;
        else opc = Opcode::XOR;
        if (mod_ == 3) {
            VarNode dst = VarNode::xmm(((di.modrm >> 3) & 7) | ((di.rex & 0x04) ? 8 : 0), 16);
            VarNode src = VarNode::xmm((di.modrm & 7) | ((di.rex & 0x01) ? 8 : 0), 16);
